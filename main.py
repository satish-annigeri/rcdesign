...
# Analysis of a rectangular beam section of size 230x450 mm overall, with above properties
xu = 150 # Assumed depth of neutral axis. May not be the true depth corresponding to equilibrium
...
# xu = 136.210193097794
print(f'Location of neutral axis')
x1, x2 = rootsearch(rect_sec.C_T, 50, 400, 10, rect_sec.conc.ecu) # Bracket the position of neutral axis
